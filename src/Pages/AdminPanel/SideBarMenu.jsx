      ...
      <div id="wrapper">
        ...
        >
          ...
          <li className="nav-item mt-3 mb-3">
            <a
              className="sidebar-brand d-flex align-items-center mt-2 justify-content-center"
              href="index.html"
            >
            ...
            <h6
              style={{ fontSize: "15px" }}
              className="text-center mt-4 text-white fw-bold"
            >
              Admin Panel
            </h6>
          </li>
                ...
                <li>
                  ...
                  >
                    <svg
                      ...
                      height="16"
                      fill="currentColor"
                      className="bi bi-person-lines- me-2"
                      viewBox="0 0 16 16"
                    >
                ...
                <li>
                  ...
                  >
                    <svg
                      ...
                      height="16"
                      fill="currentColor"
                      className="bi bi-node-plus me-2"
                      viewBox="0 0 16 16"
                    >
                      <path
                        fillRule="evenodd"
          ...
          <li className="nav-item">
            ...
            >
              <svg
                ...
                height="16"
                fill="currentColor"
                className="bi bi-journal-richtext me-2"
                viewBox="0 0 16 16"
              >
                ...
                <li>
                  ...
                  >
                    <svg
                      ...
                      height="16"
                      fill="currentColor"
                      className="bi bi-bookshelf me-2"
                      viewBox="0 0 16 16"
                    >
                ...
                <li>
                  ...
                  >
                    <svg
                      ...
                      height="16"
                      fill="currentColor"
                      className="bi bi-journal-arrow-up me-2"
                      viewBox="0 0 16 16"
                    >
                      <path
                        fillRule="evenodd"
                ...
                <li>
                  ...
                  >
                    <svg
                      ...
                      height="16"
                      fill="currentColor"
                      className="bi bi-window-plus me-2"
                      viewBox="0 0 16 16"
                    >
                    ...
                    <li>
                      ...
                      >
                        <svg
                          ...
                          height="16"
                          fill="currentColor"
                          className="bi bi-person-up me-2"
                          viewBox="0 0 16 16"
                        >
                ...
                {reportOpen && (
                  <ul className="dropdown-container">
                    ...
                    <li>
                      <button
                        className="dropdown-item"
                        onClick={() => navigate("/Admin/UserReport/Table")}
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width="16"
                    ...
                    <li>
                      <button
                        className="dropdown-item"
                        onClick={() =>
                          navigate("/Admin/SubscriptionReport/Table")
                        }
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                    ...
                    <li>
                      <button
                        className="dropdown-item"
                        onClick={() =>
                          navigate("/Admin/SubscriberRevenue/Prediction")
                        }
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
            ...
            >
              ...
              <span>
                <svg
                  ...
                  height="16"
                  fill="currentColor"
                  className="bi bi-node-plus-fill me-2"
                  viewBox="0 0 16 16"
                >
                ...
                <li>
                  ...
                  >
                    ...
                    >
                      <path
                        fillRule="evenodd"
                        d="M0 .5A.5.5 0 0 1 .5 0h9a.5.5 0 0 1 0 1h-9A.5.5 0 0 1 0 .5m13 0a.5.5 0 0 1 .5-.5h2a.5.5 0 0 1 0 1h-2a.5.5 0 0 1-.5-.5m-13 2A.5.5 0 0 1 .5 2h8a.5.5 0 0 1 0 1h-8a.5.5 0 0 1-.5-.5m13 0a.5.5 0 0 1 .5-.5h2a.5.5 0 0 1 0 1h-2a.5.5 0 0 1-.5-.5m-13 2A.5.5 0 0 1 .5 4h10a.5.5 0 0 1 0 1H.5a.5.5 0 0 1-.5-.5m13 0a.5.5 0 0 1 .5-.5h2a.5.5 0 0 1 0 1h-2a.5.5 0 0 1-.5-.5m-13 2A.5.5 0 0 1 .5 6h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5m13 0a.5.5 0 0 1 .5-.5h2a.5.5 0 0 1 0 1h-2a.5.5 0 0 1-.5-.5"
                      />
                    </svg>
                    Manage user
                  </button>
